#!/usr/bin/python3
"""HBnB console module - defines the HBnB console."""
import cmd
import re
...
class HBnBCommandInterpreter(cmd.Cmd):
    ...
    Attributes:
        ...
        classes (set): Set containing all available class names.
    """
    ...
    def do_create(self, arg):
        ...
        elif argl[0] not in HBnBCommandInterpreter.classes:
    ...
    def do_all(self, arg):
        ...
        argl = parse_arguments(arg)
        if len(argl) > 0 and argl[0] not in HBnBCommandInterpreter.classes:
            print("** class doesn't exist **")
        else:
            objl = []
    ...
    def do_update(self, arg):
        ...
        if len(argl) == 0:
            print("** class name missing **")
            return False
        if argl[0] not in HBnBCommandInterpreter.classes:
            print("** class doesn't exist **")
            return False
        if len(argl) == 1:
            print("** instance id missing **")
